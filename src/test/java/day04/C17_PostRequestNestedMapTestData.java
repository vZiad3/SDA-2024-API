 ...
 */
    ...
    public void postNestedMapTest(){
        ...
        Map<String,Object> bookingdates= RestulTestData.bookingDatesMapper("2023-03-07","2024-09-25");

        Map<String ,Object> payLoad = RestulTestData.bookingMapper("John","Doe",15,true,bookingdates,"Lunch");
